...
public:
    ...
    Int_t SaveNewDataBase(const TString DataBaseName); // Memory -> Database file
    ...
    const TVector3 GetSieveHoleTCS_PRex(TString hrs, UInt_t Col, UInt_t Row);
    ...
    TCanvas* CheckSieve(Int_t PlotFoilID ,std::string resultSavePath);
    ...
    TCanvas* CheckDp_test(std::string resultSavePath);
    TCanvas* CheckDp_test2(std::string resultSavePath);
