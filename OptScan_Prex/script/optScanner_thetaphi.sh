...
#analyzer -b -q .L rootlogon.C 'ROpticsOptScript.C('true',"phi","'${OptimizedThetaDBFname}'","'${OptimizedThetaDBFname}'")'
#analyzer -b -q .L rootlogon.C 'ROpticsOptScript.C('true',"theta","'${OptimizedThetaDBFname}'","'${OptimizedThetaDBFname}'")'
